  ...
  },
  {
    ...
    tag: "Famous Quote"
     ...
     return(
      ...
      <div className='quote--div' style={{backgroundColor: backgroundColor.backgroundColor, color: textColor.textColor}}>
      <QuoteMachine quote ={quote} />
      <div className="btn--flex">
      <Link to ="/"> <button className='home--page'>Home Page</button></Link>
      <button classname="btn" onClick={handleClick}>Generate New Quote</button>
      </div> 
